...
func New(searchHandler *handler.SearchHandler, port string, log *slog.Logger) *Server {
	app := fiber.New(fiber.Config{
		AppName:      "Nafer Search Service",
	...
	app.Get("/health", func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{"status": "ok", "service": "search"})
	})
