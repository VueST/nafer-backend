...
func New(commentHandler *handler.CommentHandler, port string, log *slog.Logger) *Server {
	app := fiber.New(fiber.Config{
		AppName:      "Nafer Comment Service",
	...
	app.Get("/health", func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{"status": "ok", "service": "comment"})
	})
